...
<body class="home page-template-default page page-id-382 wp-custom-logo wp-embed-responsive gads-page">
...
<div id="quotation" class="wp-block-uagb-container crf-form-wrapper inpage-section uagb-block-c19de64c alignfull uagb-is-root-container">
  <div class="uagb-container-inner-blocks-wrap">
    <section class="gads-hero">
      <div class="gads-hero__content">
        <div class="gads-hero__eyebrow">Bangalore CCTV Experts</div>
        <h1 class="gads-hero__title">CCTV Installation in Bangalore - Starting ₹4999</h1>
        <div class="gads-hero__subtext">
          <span>2 Years Service Warranty</span>
          <span>5 Years Warranty with AMC</span>
          <span>Free Installation</span>
        </div>
        <div class="gads-trust-bar">4.8 Rating | 500+ Installations | Trusted by Homes &amp; Offices</div>
        <div class="gads-cta-group">
          <a class="gads-cta gads-cta--whatsapp" href="https://wa.me/918884831000?text=Hi%20Smartronic%2C%20I%20need%20a%20CCTV%20installation%20quote." target="_blank" rel="noopener">Get Quote on WhatsApp</a>
          <a class="gads-cta gads-cta--call" href="tel:8884831000">Call Now</a>
        </div>
        <div class="gads-pricing-card">
          <div class="gads-pricing-card__title">Quick Pricing Preview</div>
          <div class="gads-pricing-list">
            <div class="gads-pricing-item"><span>2 Camera Setup</span><strong>₹4999</strong></div>
            <div class="gads-pricing-item"><span>4 Camera Setup</span><strong>₹8999</strong></div>
            <div class="gads-pricing-item"><span>8 Camera Setup</span><strong>₹14999</strong></div>
          </div>
        </div>
      </div>

      <div class="gads-hero__form-column">
              ...
              <div class="wp-block-uagb-info-box uagb-block-174b2c13 uagb-infobox__content-wrap uagb-infobox-icon-left uagb-infobox-left uagb-infobox-stacked-tablet uagb-infobox-image-valign-middle wp-block-uagb-info-box--has-margin"><div class="uagb-infobox-margin-wrapper">
                ...
                <div class="uagb-ifb-content">
                  ...
                  <div class="uagb-ifb-desc">
                    <p>Schedule your CCTV installation today and enjoy a <span class="hl">₹1500 discount </span> on your final payment! <br><small>Offer valid on all orders with 8 cameras or more.</small></p>
                  </div>
                </div>
              </div></div>
            </div>
        ...
        <div class="wp-block-column form-holder is-layout-flow wp-block-column-is-layout-flow">
          <div class="crf-container">
            <div class="gads-form-card">
              <div class="gads-form-card__header">
                <h2>Get Free CCTV Quote in 30 Seconds</h2>
                <p>Share your details and our expert will help you choose the right setup.</p>
              </div>
              <form id="cctv-requirement-form" class="crf-form gads-form">
                <div class="crf-form-row gads-form-row-visible">
                  <div class="crf-form-col">
                    <label for="gads-name">Name</label>
                    <input type="text" id="gads-name" class="input" placeholder="Your name">
                  </div>
                </div>

                <div class="crf-form-row bg-camera gads-hidden-field">
                  <div class="crf-form-col">
                ...
                <div class="crf-form-row gads-hidden-field">
                  <div class="crf-form-col">
                ...
                <div class="crf-form-row gads-form-row-visible">
                  <div class="crf-form-col">
                    <label for="num-whatsapp">Phone / WhatsApp Number</label>
                    <div class="slider-input-wrapper input-with-icon">
                      ...
                      <input type="tel" id="num-whatsapp" class="input" placeholder="Your phone number">
                    </div>
                    <small>Our expert will call you within 5 minutes.</small>
                  </div>
                </div>
                ...
                <button type="submit" id="next-button" class="input">Get Free Quote</button>
              ...
              <div class="gads-form-card__microcopy">Our expert will call you within 5 minutes</div>
            </div>
          </div>
        </div>
      </div>
...
<a href="https://smartronic.online/admin_v2/smart/whatsapp_leads.php?key=9f4a73c2e9b84bdc902f1a7e5d13acbd" style="display:none;">
  ...
  <div class="gads-mobile-bar">
    <a class="gads-mobile-bar__btn gads-mobile-bar__btn--whatsapp" href="https://wa.me/918884831000?text=Hi%20Smartronic%2C%20I%20need%20a%20CCTV%20installation%20quote." target="_blank" rel="noopener">WhatsApp</a>
    <a class="gads-mobile-bar__btn gads-mobile-bar__btn--call" href="tel:8884831000">Call Now</a>
  </div>

  <div class="gads-modal" id="gadsLeadModal" aria-hidden="true">
    <div class="gads-modal__backdrop" data-close-gads-modal="true"></div>
    <div class="gads-modal__dialog" role="dialog" aria-modal="true" aria-labelledby="gadsLeadModalTitle">
      <button type="button" class="gads-modal__close" id="gadsLeadModalClose" aria-label="Close popup">x</button>
      <div class="gads-modal__eyebrow">Free Consultation</div>
      <h3 id="gadsLeadModalTitle">Get Your CCTV Quote</h3>
      <p>Share your number and our expert will call you in 5 minutes.</p>
      <div class="gads-modal__form">
        <label for="gads-modal-name">Name</label>
        <input type="text" id="gads-modal-name" class="input" placeholder="Your name">
        <label for="gads-modal-phone">Phone / WhatsApp Number</label>
        <input type="tel" id="gads-modal-phone" class="input" placeholder="Your phone number">
      </div>
      <div class="gads-modal__actions">
        <button type="button" class="gads-cta gads-cta--submit" id="gadsModalSubmit">Submit</button>
        <a class="gads-cta gads-cta--whatsapp" href="https://wa.me/918884831000?text=Hi%20Smartronic%2C%20I%20need%20a%20CCTV%20installation%20quote." target="_blank" rel="noopener">WhatsApp</a>
      </div>
    </div>
  </div>
...
document.addEventListener("DOMContentLoaded", function () {
  const modal = document.getElementById("gadsLeadModal");
  const modalClose = document.getElementById("gadsLeadModalClose");
  const modalSubmit = document.getElementById("gadsModalSubmit");
  const modalName = document.getElementById("gads-modal-name");
  const modalPhone = document.getElementById("gads-modal-phone");
  const heroName = document.getElementById("gads-name");
  const heroPhone = document.getElementById("num-whatsapp");
  const mainForm = document.getElementById("cctv-requirement-form");

  if (!modal || !heroPhone || !mainForm) {
    return;
  }
  ...
  const openModal = () => {
    if (modalDismissed || (heroPhone.value && heroPhone.value.trim().length > 0)) {
      return;
    }
  ...
  modal.addEventListener("click", function (event) {
    if (event.target && event.target.getAttribute("data-close-gads-modal") === "true") {
      modalDismissed = true;
      closeModal();
    }
  });
  ...
  if (modalName && heroName) {
    heroName.addEventListener("input", function () {
      if (!modalName.value) {
        modalName.value = heroName.value;
      }
    });
  }
  ...
  if (modalSubmit && modalPhone) {
    modalSubmit.addEventListener("click", function () {
      if (heroName && modalName) {
        heroName.value = modalName.value;
      }
      heroPhone.value = modalPhone.value;
      closeModal();
...
.gads-page .crf-form-wrapper {
    background:
      radial-gradient(circle at top left, rgba(21, 88, 214, 0.12), transparent 38%),
      linear-gradient(180deg, #f7fbff 0%, #ffffff 100%);
    padding: 24px 0 48px;
}

.gads-page #quotation,
.gads-page #quotation .uagb-container-inner-blocks-wrap {
    max-width: 1240px;
    margin: 0 auto;
}
...
.gads-form-card {
    ...
    border-radius: 28px;
    box-shadow: 0 18px 50px rgba(25, 42, 70, 0.12);
}
...
.gads-cta {
    ...
    font-size: 16px;
    font-weight: 800;
    box-shadow: 0 14px 24px rgba(20, 31, 51, 0.14);
...
.gads-cta:focus {
    ...
    box-shadow: 0 16px 26px rgba(20, 31, 51, 0.18);
}
...
.gads-pricing-card {
    margin-top: 20px;
    background: linear-gradient(135deg, #162033 0%, #253552 100%);
    color: #fff;
    border-radius: 24px;
    padding: 20px;
...
.gads-pricing-item span {
    color: rgba(255, 255, 255, 0.82);
}

.gads-pricing-item strong {
    font-size: 18px;
    color: #fff;
}
...
.gads-form-card__header p {
    margin: 0 0 18px;
    color: #50627b;
}

.gads-form-card__microcopy {
    margin-top: 12px;
    font-size: 14px;
    color: #44617e;
    text-align: center;
...
.gads-form .crf-form-row {
    display: block;
    margin-bottom: 14px;
}

.gads-form .crf-form-col {
    width: 100%;
}

.gads-form .slider-input-wrapper {
    width: 100%;
    max-width: 100%;
}

.gads-form .crf-form-col > label {
    font-size: 15px;
    font-weight: 700;
    margin-bottom: 6px;
    display: block;
...
.gads-form .input-with-icon .input {
    padding-left: 54px;
}

.gads-form .input-icon {
    width: 24px;
    height: 24px;
    left: 16px;
}
...
.gads-modal__dialog {
    ...
    border-radius: 24px;
    padding: 22px;
    box-shadow: 0 24px 60px rgba(10, 20, 36, 0.34);
    z-index: 1;
}
...
.gads-modal__dialog h3 {
    margin: 14px 0 8px;
    font-size: 28px;
    line-height: 1.1;
}

.gads-modal__dialog p {
    margin: 0 0 16px;
    color: #50627b;
}

.gads-modal__form label {
    display: block;
    margin: 0 0 6px;
    font-size: 14px;
    font-weight: 700;
...
@media (max-width: 767px) {
    ...
    .gads-mobile-bar__btn--whatsapp {
        background: #25d366;
    }

    .gads-mobile-bar__btn--call {
        background: #f40009;
    }
}
