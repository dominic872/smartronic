...
<link rel="stylesheet" href="/ro-water-purifier/css/ro-water-purifier.css">

<style id="ro-water-filter-theme">
  :root {
    --ro-page-bg: #ffffff;
    --ro-page-fg: #ffffff;
    --ro-page-body-bg: #ffffff;
    --ro-card-bg: rgba(0, 0, 0, 0.35);
    --ro-card-border: rgba(255, 255, 255, 0.12);
  }
  ...
  main .uagb-section__wrap,
  main .wp-block-columns,
  main .wp-block-column,
  main .wp-block-uagb-info-box,
  main .uagb-ifb-content,
  main .uagb-faq__outer-wrap,
  main .uagb-faq-child__outer-wrap,
  main .uagb-faq-content,
  main .crf-form-wrapper,
  footer .wp-block-group,
  footer .wp-block-uagb-container,
  footer .uagb-container-inner-blocks-wrap,
  footer .uagb-section__wrap,
  footer .wp-block-columns,
  footer .wp-block-column,
  footer .uagb-ifb-content {
    background: var(--ro-page-bg) !important;
    background-color: var(--ro-page-bg) !important;
  }

  main,
  footer {
    color: var(--ro-page-fg) !important;
  }

  footer.wp-block-template-part, footer .wp-block-group, footer .wp-block-columns, footer .wp-block-column {
    background: #00314c !important;
    background-color: #00314c !important;
  }

  main :where(p, li, span, small, strong, em, h1, h2, h3, h4, h5, h6, label, .uagb-heading-text, .uagb-desc-text, .uagb-ifb-title, .uagb-ifb-desc, .uagb-question, .gads-desc, .shimmer-text),
  footer :where(p, li, span, small, strong, em, h1, h2, h3, h4, h5, h6, label) {
    color: var(--ro-page-fg) !important;
  }
  ...
  main .ro-two-col > .wp-block-columns {
    gap: 18px;
  ...
  main .ro-card {
    ...
    border: 1px solid var(--ro-card-border);
    border-radius: 14px;
    padding: 14px;
  }
  ...
  .crf-form-wrapper #cctv-requirement-form {
  ...
  .crf-form-wrapper :where(p, li, span, small, strong, em, h1, h2, h3, h4, h5, h6, label, a, input, textarea, select, option, button, .uagb-heading-text, .uagb-desc-text, .uagb-ifb-title, .uagb-ifb-desc) {
    color: #000 !important;
  }

  #cctv-requirement-form .ro-plan-picker {
    margin: 2px 0 14px;
  }

  #cctv-requirement-form .ro-plan-options {
    display: flex;
    flex-wrap: nowrap;
    gap: 10px;
  ...
  #cctv-requirement-form .ro-plan-item {
    position: relative;
    flex: 1;
  }

  #cctv-requirement-form .ro-plan-item input[type="radio"] {
    position: absolute;
    inset: 0;
    opacity: 0;
    pointer-events: none;
  ...
  #cctv-requirement-form .ro-plan-option {
    position: relative;
    display: flex;
    align-items: center;
  ...
  #cctv-requirement-form .ro-plan-option .ro-plan-caption {
    font-size: 16px;
  }

  #cctv-requirement-form .ro-plan-option .ro-plan-caption .ro-plan-monthly {
  ...
  #cctv-requirement-form .ro-plan-option :is(img, svg, i) {
    max-height: 20px;
    max-width: 20px;
    margin-right: 8px;
    flex: 0 0 auto;
  ...
  #cctv-requirement-form .ro-plan-item input[type="radio"]:checked + .ro-plan-option {
    border-color: #87CEEB;
    box-shadow: 0 14px 34px rgba(135, 206, 235, 0.5);
    transform: translateY(-1px);
    background: #5abcd8;
    color: white !important;
  }
#cctv-requirement-form .ro-plan-item input[type="radio"]:checked + .ro-plan-option span{
  color: white !important;
}
  #cctv-requirement-form .ro-plan-option::after {
    content: "";
    position: absolute;
    left: 50%;
    bottom: -10px;
    ...
    filter: drop-shadow(0 6px 8px rgba(17, 24, 39, 0.10));
  }

  #cctv-requirement-form .ro-plan-item input[type="radio"]:checked + .ro-plan-option::after {
    border-top-color: #5abcd8;
  }

  #cctv-requirement-form .ro-plan-item input[type="radio"]:not(:checked) + .ro-plan-option::after {
    display: none !important;
  }

  #cctv-requirement-form .ro-plan-option[data-badge]::before {
    ...
    box-shadow: 0 10px 22px rgba(47, 104, 228, 0.18);
  }

  #cctv-requirement-form .ro-plan-summary {
    margin-top: 12px;
    padding: 12px 12px;
    border-radius: 4px;
  ...
  #cctv-requirement-form .ro-plan-summary .ro-plan-summary-term {
    font-size: 16px;
    font-weight: 700;
    line-height: 1.15;
  }

  #cctv-requirement-form .ro-plan-summary .ro-plan-summary-price {
    margin-top: 6px;
    font-size: 18px;
    font-weight: 800;
    line-height: 1.1;
  ...
  #cctv-requirement-form .ro-plan-summary-col-1 {
    flex-basis: 40%;
  }

  #cctv-requirement-form .ro-plan-summary-col-2 {
    flex-basis: 60%;
    text-align: left;
    padding-left: 10px;
    border-left: 2px solid #00c676; /* Green border */
  }

  #cctv-requirement-form .ro-plan-summary-col-2 p {
    margin: 0;
    font-size: 14px;
    font-weight: 600;
    line-height: 1.5;
  ...
  main .hero-desktop img {
    border-radius: 8px !important;
  }

  main .hero-desktop .hero-caption-band {
    background: #e8f0fe !important;
    border-radius: 8px !important;
    color: #000 !important;
  }

  main .hero-desktop .hero-caption-band :where(p, li, span, small, strong, em, h1, h2, h3, h4, h5, h6, label, a, .uagb-heading-text, .uagb-desc-text, .uagb-ifb-title, .uagb-ifb-desc) {
    color: #000 !important;
  }

  main .ro-left-stack > .ro-card:first-of-type {
    background: #fce8e6 !important;
    border-radius: 8px !important;
  }

  main .ro-left-stack > .ro-card:nth-of-type(2) {
    background: #fef7e0 !important;
    border-radius: 8px !important;
  }

  main .uagb-ifb-desc.gads-text {
    display: none !important;
  }

  main .ro-left-stack > .ro-card {
    font-family: "Raleway", sans-serif !important;
    color: #000 !important;
  }

  main .ro-left-stack > .ro-card :where(p, li, span, small, strong, em, h1, h2, h3, h4, h5, h6, label, a, .uagb-heading-text, .uagb-desc-text, .uagb-ifb-title, .uagb-ifb-desc) {
    color: #000 !important;
  }

  main .ro-left-stack > .ro-card .uagb-ifb-title {
    font-family: "Raleway", sans-serif !important;
  ...
  main .ro-left-stack > .ro-card .uagb-ifb-desc {
    font-family: "Raleway", sans-serif !important;
  ...
  main .ro-compare-section {
    max-width: 1200px;
    margin: 22px auto 0;
    padding: 0 16px;
  }

  main .ro-compare-table-wrap {
    border: 1px solid var(--ro-card-border);
    border-radius: 16px;
    overflow: hidden;
    background: rgba(0, 0, 0, 0.18);
  ...
  main .ro-compare-scroll {
    overflow: auto;
    -webkit-overflow-scrolling: touch;
  }

  main .ro-compare-table {
    width: 100%;
    min-width: 860px;
    border-collapse: collapse;
  }

  main .ro-compare-table th,
  main .ro-compare-table td {
    padding: 14px 12px;
    border-bottom: 1px solid rgba(255, 255, 255, 0.08);
    vertical-align: middle;
  }

  main .ro-compare-table thead th {
    border-bottom: 1px solid rgba(255, 255, 255, 0.14);
    text-align: center;
  }

  main .ro-compare-table thead th:first-child {
    text-align: left;
  }

  main .ro-compare-table tbody th {
    text-align: left;
    font-weight: 600;
  }
  ...
  .new-comparison-button-container {
    text-align: center; 
    margin-top: 30px;
    margin-bottom: 50px;
  }
  ...
  .modal-header h2 {
    margin: 0;
    color: white !important; /* Ensure heading color is white */
  }
  ...
  main .ro-plan--popular {
    position: relative;
  }

  main .ro-plan--popular::before {
  ...
  main .ro-compare-table thead th.ro-plan--popular,
  main .ro-compare-table tbody td.ro-plan--popular {
    background: rgba(0, 0, 0, 0.28);
    box-shadow: inset 0 0 0 2px rgba(0, 198, 118, 0.55);
  }
  ...
  main .ro-check {
    ...
    align-items: center;
    justify-content: center;
    background: rgba(0, 198, 118, 0.16);
    border: 1px solid rgba(0, 198, 118, 0.35);
  ...
  .ro-features-card {
    ...
    align-items: center;
    padding: 15px 20px;
    background: linear-gradient(90deg, rgba(237, 230, 255, 0.7) 0%, rgba(229, 246, 255, 0.7) 100%);
    border: none;
    box-shadow: 0 10px 20px rgba(0, 0, 0, 0.05);
    margin-bottom: 14px; /* To separate it from the card below */
  }
  ...
  .ro-feature-item i {
    font-size: 24px;
    color: #5c6bc0; /* A shade of blue/purple for icons */
    margin-bottom: 8px;
  }

  .ro-feature-item span {
    display: block;
  }
  ...
  @media (max-width: 768px) {
    ...
    .ro-feature-item {
      flex-basis: 45%; /* Two items per row on smaller screens */
    }
  }
  ...
  #cctv-requirement-form .crf-form-row:not(#whatsapp-row) {
    display: none !important;
  }
        ...
        <div class="uagb-ifb-title-wrap">
          <?php if ($is_gads_13k): ?>
            <h2 class="uagb-ifb-title">
              Pure Water for Your Family. Total Peace of Mind for 2 Years.<br>
              RO Water Purifier with FREE 2-Year Complete Warranty & Filter Replacement.
             RO Water Purifier with  <span class="hl">FREE 2-Year Complete Warranty</span>
            </h2>
          <?php else: ?>
            <h2 class="uagb-ifb-title">
              Get Pure Drinking Water with 2 Years Complete Protection <br>
              RO Water Purifier with  <span class="hl">FREE 2-Year Complete Warranty</span>
            </h2>
          <?php endif; ?>
        </div>
...
<div class="wp-block-uagb-container uagb-block-a752a79e ro-two-col">
<div class="wp-block-columns is-layout-flex wp-container-core-columns-is-layout-3 wp-block-columns-is-layout-flex">
<div class="wp-block-column form-holder ro-right-col is-layout-flow wp-block-column-is-layout-flow"></div>



<div class="wp-block-column ro-left-col is-layout-flow wp-block-column-is-layout-flow">
<div class="ro-left-stack">
<div class="premium-hero-v3-slider">
  <div class="phv2-v3-inner">
    <div class="phv2-v3-slides">
      <section class="phv2-v3-slide is-active" data-delay="5200">
        <div class="phv2-content">
          <img src="ro-water-purifier/image/carezero.png" alt="Care Zero Logo" class="phv2-controls-logo">
          <h1>Drink Pure. <br>Pay Once. <br>Relax for Years</h1>
          <p>Warranty and filter replacement included — safe water, predictable costs.</p>
        </div>
      </section>
      <section class="phv2-v3-slide" data-delay="5600">
        <div class="phv2-content">
          <img src="ro-water-purifier/image/carezero.png" alt="Care Zero Logo" class="phv2-controls-logo">
          <h1>Engineered for Purity. <br>Backed by Total Protection.</h1>
          <p>Advanced 7-stage filtration with 2 years of complete maintenance coverage built in.</p>
        </div>
      </section>
      <section class="phv2-v3-slide" data-delay="5900">
        <div class="phv2-content">
          <img src="ro-water-purifier/image/carezero.png" alt="Care Zero Logo" class="phv2-controls-logo">
          <h1>Stop Paying, <br>Again and Again for Water.</h1>
          <p>Lock your cost for 2 years and enjoy pure, healthy drinking water without recurring expenses.</p>
        </div>
      </section>
    </div>
    <div class="phv2-v3-mosaic">
      <div class="phv2-mosaic">
        <div class="phv2-tile tile-same shuffle-tile"><div class="phv2-tile-inner photo-border"><img loading="lazy" decoding="async" src="ro-water-purifier/image/girl%20with%20a%20glass%20of%20water%20smartronic%20carezero.png" alt="Girl with a glass of water Smartronic Carezero"></div></div>
        <div class="phv2-tile tile-same shuffle-tile"><div class="phv2-tile-inner photo-border"><img loading="lazy" decoding="async" src="ro-water-purifier/image/happy%20family%20smartronic%20ro%20water%20filter%20carezero%20.png" alt="Happy family Smartronic RO water filter Carezero"></div></div>
        <div class="phv2-tile tile-same shuffle-tile"><div class="phv2-tile-inner photo-border"><img loading="lazy" decoding="async" src="ro-water-purifier/image/doctor%20smartronic%20carezero%20water%20purifier.png" alt="Doctor with Smartronic Carezero water purifier"></div></div>
        <div class="phv2-tile tile-same shuffle-tile"><div class="phv2-tile-inner photo-border"><img loading="lazy" decoding="async" src="ro-water-purifier/image/elders%20with%20smartronic%20water%20purifier%20ro%20carezero.png" alt="Elders with Smartronic water purifier RO Carezero"></div></div>
      </div>
    </div>
    <div class="phv2-cta-wrapper">
      <a class="phv2-cta" href="#services">Explore Now</a>
      <button class="phv2-toggle" type="button" aria-pressed="false" aria-label="Pause"><i class="fa-solid fa-pause"></i></button>
    </div>
  </div>
</div>
<section class="hero">
  <div class="hero-desktop">
    <div class="hero-media">
      <img decoding="async" src="ro-water-purifier/image/hero-water.png" alt="Pure drinking water" loading="eager" fetchpriority="high">

      <div class="hero-caption-band">
        <div class="text">
          <div class="uagb-ifb-title-wrap">
            <h2 class="uagb-ifb-title">2 Year Un-conditional Warranty</h2>
          </div>
          <p class="uagb-ifb-desc">Free Filter Replacement for 2 Years</p>
        </div>

        <div class="text">
          <div class="uagb-ifb-title-wrap">
            <h2 class="uagb-ifb-title">7-Stage Filtration</h2>
          </div>
          <p class="uagb-ifb-desc">Advance Filteration Technology<br>Removes even the toughest contaminants<br> Ensures Pure Water</p>
        </div>
      </div>
    </div>
    <div class="new-comparison-button-container">
      <button class="phv2-cta">Get Care Zero Now</button>
    </div>
  </div>
</section>
<section class="new-comparison-section">
  <h2 class="new-comparison-heading">Drink Pure. Pay Once. Stay Protected.</h2>

  <div class="comparison-rows">
    <div class="comparison-row highlighted-row">
        <div class="row-label can-water-label">
            <img src="ro-water-purifier/image/carezero.png" alt="Care Zero Logo" class="logo-image">
        </div>
        <div class="steps-container">
            <div class="step">
                <i class="fa-solid fa-cart-arrow-down icon"></i>
                <span class="step-text">Buy</span>
                <div class="step-description"><i class="fa-solid fa-check" style="color: #00c853; margin-right: 5px;"></i>One-time purchase. No future surprises.</div>
            </div>
            <div class="step">
                <i class="fa-solid fa-couch icon"></i>
                <span class="step-text">Relax</span>
                <div class="step-description"><i class="fa-solid fa-check" style="color: #00c853; margin-right: 5px;"></i>Zero service worries for years.</div>
            </div>
            <div class="step">
                <i class="fa-solid fa-droplet icon"></i>
                <span class="step-text">Drink Pure</span>
                <div class="step-description"><i class="fa-solid fa-check" style="color: #00c853; margin-right: 5px;"></i>Consistently clean, healthy drinking water.</div>
            </div>
            <div class="step">
                <i class="fa-solid fa-sack-dollar icon"></i>
                <span class="step-text">Save</span>
                <div class="step-description"><i class="fa-solid fa-check" style="color: #00c853; margin-right: 5px;"></i>No extra bills. Real long-term savings.</div>
            </div>
        </div>
    </div>

    <div class="comparison-row">
        <div class="row-label other-ro-label">
            <img src="https://smartronic.online/ro-water-purifier/image/other_filter.png" alt="Other RO" class="logo-image">
        </div>
        <div class="steps-container">
            <div class="step">
                <i class="fa-solid fa-cart-arrow-down icon"></i>
                <span class="step-text">Buy</span>
                <div class="step-description"><i class="fa-solid fa-check" style="color: #00c853; margin-right: 5px;"></i>Initial purchase looks affordable.</div>
            </div>
            <div class="step">
                <i class="fa-solid fa-money-bill-trend-up icon"></i>
                <span class="step-text">Pay Again</span>
                <div class="step-description"><i class="fa-solid fa-xmark" style="color: #a00000; margin-right: 5px;"></i>Repeated filter and service costs.</div>
            </div>
            <div class="step">
                <i class="fa-regular fa-face-sad-cry icon"></i>
                <span class="step-text">Worry</span>
                <div class="step-description"><i class="fa-solid fa-xmark" style="color: #a00000; margin-right: 5px;"></i>Water quality drops over time.</div>
            </div>
            <div class="step">
                <i class="fa-solid fa-indian-rupee-sign icon"></i>
                <span class="step-text">Spend More</span>
                <div class="step-description"><i class="fa-solid fa-xmark" style="color: #a00000; margin-right: 5px;"></i>Hidden expenses keep adding up.</div>
            </div>
        </div>
    </div>
    ...
    <div class="comparison-row">
        <div class="row-label can-water-label">
            <img src="https://smartronic.online/ro-water-purifier/image/water_can.png" alt="Can Water" class="logo-image">
        </div>
        <div class="steps-container">
            <div class="step">
                <i class="fa-solid fa-cart-arrow-down icon"></i>
                <span class="step-text">Buy Daily</span>
                <div class="step-description">Regular dependency on deliveries.</div>
            </div>
            <div class="step">
                <i class="fa-solid fa-couch icon"></i>
                <span class="step-text">Risk Quality</span>
                <div class="step-description">No control over purity.</div>
            </div>
            <div class="step">
                <i class="fa-solid fa-droplet icon"></i>
                <span class="step-text">Spend Forever</span>
                <div class="step-description">Money drains every single month.</div>
            </div>
            <div class="step">
                <i class="fa-solid fa-indian-rupee-sign icon"></i>
...
<div class="ro-card ro-features-card">
  <div class="ro-feature-item">
    <i class="fas fa-shield-alt"></i>
    <span>Lifetime Free<br>Maintenance</span>
  </div>
  <div class="ro-feature-item">
    <i class="fas fa-calendar-alt"></i>
    <span>7 days<br>Risk-Free Trial</span>
  </div>
  <div class="ro-feature-item">
    <i class="fas fa-clock"></i>
    <span>48-hour<br>Installation</span>
  </div>
  <div class="ro-feature-item">
    <i class="fas fa-rupee-sign"></i>
    <span>Plans starting<br>349/month</span>
  </div>
</div>

<div class=""><div class="crf-container">

    </div>
    <div class="ro-card ro-plan-card">
      <div class="uagb-ifb-title-wrap">
        <h3 class="uagb-ifb-title">Plan Details</h3>
      </div>
      <p class="uagb-ifb-desc">Choose a plan that fits your home. Includes installation support, periodic checkups, and quick service scheduling.</p>
      <ul class="ro-tags">
...
<section class="ro-card water-usage-section">
  <div class="uagb-ifb-title-wrap">
    <h3 class="new-comparison-heading">Water Usage Calculator</h3>
  </div>
  <h4 class="water-usage-heading">How Much Are You Spending on Drinking Water?</h4>
  <div class="water-usage-options">
    <label class="water-usage-option">
      <img src="ro-water-purifier/image/water_can.png" alt="Water can">
      <span class="water-usage-label">Water can</span>
      <input type="radio" name="water-usage-type" value="can-water" checked>
    </label>
    <label class="water-usage-option">
      <img src="ro-water-purifier/image/other_filter.png" alt="Water Filter">
      <span class="water-usage-label">Water Filter</span>
      <input type="radio" name="water-usage-type" value="other-filters">
    </label>
  </div>

  <!-- Price per can input (shown when 'can-water' is selected) -->
  <div id="can-price-question" style="display:none;">
    
    <div class="can-calculator-grid">
      <!-- Column 1: Input & Comparison -->
      <div class="can-calc-col-1">
        <label for="can-price" class="calc-question">How much do you pay per can?</label>
        <input 
          type="number" 
          id="can-price" 
          name="can-price" 
        ...
        <div class="calc-comparison">
          <h4>Your Final Comparison</h4>
          
          <!-- Current Choice Table -->
          <p class="current-choice-label">Your Current Choice: <span id="current-annual-cost" style="color:#d9534f;">₹0</span> per year</p>
          <div class="table-responsive">
            <table class="comparison-table current-choice-table">
              <tbody>
                <tr class="price-row">
                  <td rowspan="2" class="img-col"><img src="ro-water-purifier/image/water_can.png" alt="Water Can" class="water-can-img-small"></td>
                  <td class="cc-y1 cc-price">₹0</td>
                  <td class="cc-y2 cc-price">₹0</td>
                  <td class="cc-y3 cc-price">₹0</td>
                  <td class="cc-y4 cc-price">₹0</td>
                  <td class="cc-y5 cc-price">₹0</td>
                  <td class="cc-total cc-price">₹0</td>
                </tr>
                <tr class="year-row">
                  <td>Year 1</td>
                  <td>Year 2</td>
          ...
          <!-- Care Zero Table -->
          <div class="table-responsive">
            <table class="comparison-table care-zero-table">
              <tbody>
                <tr class="price-row">
                  <td rowspan="2" class="img-col"><img src="ro-water-purifier/image/carezero.png" alt="Care Zero" class="carezero-logo-small"></td>
                  <td class="cz-y1 cz-price">₹2796</td>
                  <td class="cz-y2 cz-price">₹2796</td>
                  <td class="cz-y3 cz-price">₹2796</td>
                  <td class="cz-y4 cz-price">₹2796</td>
                  <td class="cz-y5 cz-price">₹2796</td>
                  <td class="cz-total cz-price">₹13980</td>
                </tr>
                <tr class="year-row">
                  <td>Year 1</td>
                  <td>Year 2</td>
          ...
          <div class="savings-summary">
             <div class="savings-line">
               You save  <span class="savings-highlight" id="savings-1y-val">₹0</span> per year with <strong>CARE ZERO</strong>
             </div>
             <div class="savings-line">
               You save <span class="savings-highlight" id="savings-5y-val">₹0</span> in 5 years
             </div>
          </div>
      ...
      <!-- Column 2: Risk Meter & Summary -->
      <div class="can-calc-col-2">
        <div id="risk-display" style="display:block; text-align: center;">
            <p id="annual-cost" style="margin-bottom: 5px; font-weight: bold; color: #333;"></p>
            <p id="monthly-cans" style="margin-bottom: 10px; font-size: 14px; color: #666;"></p>
            
            <label style="display:block; font-weight:bold; margin-bottom:10px; color:#333;">Health Assessment</label>
            <div class="risk-meter-sprite high" title="High Risk"></div>
            <p id="risk-text" style="margin-top: 5px; font-weight: bold; color: #d9534f;">High Risk</p>
            
            <p style="margin-top: 15px; font-size: 13px; color: #555; line-height: 1.4;">
                Multiple studies and enforcement reports have highlighted irregularities in unlicensed packaged water units across India. <strong>Why leave your family’s drinking water quality to chance?</strong>
            </p>
        </div>
      </div>
    </div>
  ...
  <!-- Initial Purifier Cost input (shown when 'other-filters' is selected) -->
  <div id="filter-price-question" style="display:none;">
    <div class="can-calculator-grid">
      <!-- Column 1: Input & Comparison -->
      <div class="can-calc-col-1">
        <label for="filter-price" class="calc-question">What was your initial purifier cost?</label>
        <input 
          type="number" 
          id="filter-price" 
          name="filter-price" 
        ...
        <div class="calc-comparison">
          ...
          <!-- Current Choice Table for Filter -->
          <p class="current-choice-label">Your Current Choice: <span id="current-annual-cost-filter" style="color:#d9534f;">₹0</span> per year</p>
          <div class="table-responsive">
            <table class="comparison-table current-choice-table">
              <tbody>
                <tr class="price-row">
                  <td rowspan="2" class="img-col"><img src="ro-water-purifier/image/other_filter.png" alt="Other Filter" class="water-can-img-small"></td>
                  <td class="cc-y1 cc-price-filter">₹0</td>
                  <td class="cc-y2 cc-price-filter">₹0</td>
                  <td class="cc-y3 cc-price-filter">₹0</td>
                  <td class="cc-y4 cc-price-filter">₹0</td>
                  <td class="cc-y5 cc-price-filter">₹0</td>
                  <td class="cc-total cc-price-filter">₹0</td>
                </tr>
                <tr class="year-row">
                  <td>Year 1</td>
                  <td>Year 2</td>
          ...
          <!-- Savings Summary for Filter -->
          <div class="savings-summary">
             <div class="savings-line">
               You save  <span class="savings-highlight" id="savings-1y-val-filter">₹0</span> per year with <strong>CARE ZERO</strong>
             </div>
             <div class="savings-line">
               You save <span class="savings-highlight" id="savings-5y-val-filter">₹0</span> in 5 years
             </div>
          </div>
      ...
      <!-- Column 2: Risk Meter & Summary -->
      <div class="can-calc-col-2">
        <div id="risk-display-filter" class="risk-display-box" style="display:block; text-align: center;">
            <p id="annual-cost-filter" style="margin-bottom: 5px; font-weight: bold; color: #333;"></p>
            <p id="maintenance-text-filter" style="margin-bottom: 10px; font-size: 14px; color: #666;"></p>
            
            <label style="display:block; font-weight:bold; margin-bottom:10px; color:#333;">Health Assessment</label>
            <div class="risk-meter-sprite medium" title="Medium Risk"></div>
            <p id="risk-text-filter" style="margin-top: 5px; font-weight: bold; color: #ff9800;">Medium Risk</p>
            
            <p style="margin-top: 15px; font-size: 13px; color: #555; line-height: 1.4;">
                Regular maintenance is key to safe water. <strong>Ensure your filter is serviced on time to avoid health risks.</strong>
            </p>
        </div>
      </div>
    </div>
...
<!-- Moved can-price-question inside section in next step, removing from here -->
...
<div class="uagb-ifb-title-wrap"><h3 class="uagb-ifb-title">🔧 Free Professional Installation Kit</h3></div>
</div>
<p class="uagb-ifb-desc">Get a complete installation kit worth ₹1500 absolutely free. Designed for easy wall-mount or table-top setup with all required accessories included.</p>
...
<div class="uagb-ifb-title-wrap"><h3 class="uagb-ifb-title">🛡 Certified &amp; Safe Drinking Water</h3></div>
</div>
<p class="uagb-ifb-desc">ISI Marked and BIS Certified water purifier manufactured under regulatory standards for domestic safety and reliability.</p>
<div class="uagb-ifb-separator"></div>
</div></div></div>
...
<div class="uagb-ifb-title-wrap"><h3 class="uagb-ifb-title">💧 Advanced 7-Stage Filtration</h3></div>
</div>
<p class="uagb-ifb-desc">RO + UV + UF + Copper filtration with TDS control ensures removal of harmful impurities while maintaining balanced mineral levels for better taste.</p>
<div class="uagb-ifb-separator"></div>
</div></div></div>
...
<div class="uagb-ifb-title-wrap"><h3 class="uagb-ifb-title">🧼 Extra Hygiene Protection</h3></div>
</div>
<p class="uagb-ifb-desc">Silicone O-Ring sealed tank prevents cockroaches and ants from entering the storage tank, ensuring 100% hygienic stored water.</p>
<div class="uagb-ifb-separator"></div>
</div></div></div>
...
<div class="uagb-ifb-title-wrap"><h3 class="uagb-ifb-title">⚡ High Performance &amp; Ample Storage</h3></div>
</div>
<p class="uagb-ifb-desc">15 Litres per hour purification capacity with 8-litre storage tank — ideal for daily family use in homes and kitchens.</p>
<div class="uagb-ifb-separator"></div>
</div></div>
</div>
</div>
...
<div class="uagb-ifb-title-wrap"><h2 class="uagb-ifb-title">Advanced Purification for Pure, Safe Drinking Water</h2></div>
<p class="uagb-ifb-desc">Engineered with multi-stage filtration, hygienic protection, and intelligent water control technology to deliver safe and great-tasting water for your family every day.</p>
</div></div>



<div class="ro-advanced-grid">

<div class="ro-advanced-card image-card">
<div class="wp-block-uagb-image alignleft uagb-block-hk68lj39 wp-block-uagb-image--layout-default wp-block-uagb-image--effect-static wp-block-uagb-image--align-left"><figure class="wp-block-uagb-image__figure"><img decoding="async" srcset="ro-water-purifier/image/7stage.jpg 1024w, ro-water-purifier/image/7stage.jpg 780w, ro-water-purifier/image/7stage.jpg 360w" sizes="auto, (max-width: 480px) 150px" src="ro-water-purifier/image/7stage.jpg" alt="" class="uag-image-717" width="1024" height="683" title="7stage" loading="lazy" role="img"></figure></div>
...
<div class="uagb-ifb-title-wrap"><h3 class="uagb-ifb-title"><strong>7-Stage <mark style="background-color:rgba(0, 0, 0, 0)" class="has-inline-color has-accent-3-color">Advanced</mark> Filtration</strong></h3></div>
<p class="uagb-ifb-desc">Our multi-stage purification system combines RO, UV, UF and Copper filtration to remove harmful impurities, bacteria, viruses, and dissolved contaminants. Each stage works together to ensure your water is clean, safe, and balanced.</p>
</div></div>
</div>

<div class="ro-advanced-card text-card placeholder-card">
<div class="uagb-ifb-content">
<div class="uagb-ifb-title-wrap"><h3 class="uagb-ifb-title"><strong>Smart <mark style="background-color:rgba(0, 0, 0, 0)" class="has-inline-color has-accent-3-color">Monitoring</mark></strong></h3></div>
<p class="uagb-ifb-desc">Stay informed with real-time indicators for filter life, water quality, and system status. Our smart monitoring ensures you always know your purifier is performing at its best.</p>
</div>
</div>

<div class="ro-advanced-card text-card">
...
<div class="uagb-ifb-title-wrap"><h3 class="uagb-ifb-title"><strong>Dual <mark style="background-color:rgba(0, 0, 0, 0)" class="has-inline-color has-accent-3-color">UV &amp; UF</mark> Protection</strong></h3></div>
<p class="uagb-ifb-desc">Enjoy microbiologically safe water with powerful UV sterilization and UF membrane protection. This dual-layer safeguard ensures protection against bacteria and harmful microorganisms — even in challenging water conditions.</p>
</div></div>
</div>

<div class="ro-advanced-card image-card">
<div class="wp-block-uagb-image alignleft uagb-block-1fkzm3il wp-block-uagb-image--layout-default wp-block-uagb-image--effect-static wp-block-uagb-image--align-left"><figure class="wp-block-uagb-image__figure"><img decoding="async" srcset="ro-water-purifier/image/tdscontrol.jpg 1024w, ro-water-purifier/image/tdscontrol.jpg 780w, ro-water-purifier/image/tdscontrol.jpg 360w" sizes="auto, (max-width: 480px) 150px" src="ro-water-purifier/image/tdscontrol.jpg" alt="" class="uag-image-715" width="1024" height="683" title="tdscontrol" loading="lazy" role="img"></figure></div>
...
<div class="uagb-ifb-title-wrap"><h3 class="uagb-ifb-title"><strong>Intelligent <mark style="background-color:rgba(0, 0, 0, 0)" class="has-inline-color has-accent-3-color">TDS Control</mark></strong></h3></div>
<p class="uagb-ifb-desc">Adjust and maintain the ideal TDS level in your drinking water. The built-in TDS controller helps retain essential minerals while reducing excess salts, giving you purified water that tastes fresh and natural.</p>
</div></div>
</div>
...
<div class="wp-block-uagb-container uagb-block-b324654b" style="--uagb-bg: url('ro-water-purifier/image/family.png');">
...
<div class="uagb-ifb-title-wrap"><h4 class="uagb-ifb-title">Smart RO Solutions for Every Home</h4></div>
<p class="uagb-ifb-desc"><strong>Residential Homes</strong><br>Ensure your family drinks safe, purified water every day. Designed for apartments, villas, and independent houses — perfect for borewell, tanker, or municipal water supply.<br><br><strong>Offices &amp; Small Businesses</strong><br>Provide clean and safe drinking water for your employees and customers. Reliable purification with consistent performance throughout the day.<br><br><strong>Suitable for Multiple Water Sources</strong><br>Engineered to purify brackish water, tap water, tanker supply, and municipal water. The advanced RO + UV + UF system adapts to different water conditions efficiently.<br><br><strong>2-Year Complete Peace of Mind</strong><br>Enjoy two years of complete maintenance support including filter replacement and essential servicing. No unexpected costs. No hidden charges. Just uninterrupted pure water.</p>
</div></div></div>



<div data-aos="fade" data-aos-duration="400" data-aos-delay="0" data-aos-easing="ease" data-aos-once="true" class="wp-block-uagb-marketing-button uagb-marketing-btn__align-left uagb-marketing-btn__align-text-right uagb-marketing-btn__icon-after uagb-block-cd967bfc wp-block-button hero-marketing-btn"><a href="#quotation" class="uagb-marketing-btn__link wp-block-button__link" target="" rel="noopener noreferrer"><span class="uagb-marketing-btn__title">GET FREE INSTALLATION &amp; 2-YEAR WARRANTY</span><svg xmlns="https://www.w3.org/2000/svg" viewbox="0 0 512 512"><path d="M384 320c-17.67 0-32 14.33-32 32v96H64V160h96c17.67 0 32-14.32 32-32s-14.33-32-32-32L64 96c-35.35 0-64 28.65-64 64V448c0 35.34 28.65 64 64 64h288c35.35 0 64-28.66 64-64v-96C416 334.3 401.7 320 384 320zM488 0H352c-12.94 0-24.62 7.797-29.56 19.75c-4.969 11.97-2.219 25.72 6.938 34.88L370.8 96L169.4 297.4c-12.5 12.5-12.5 32.75 0 45.25C175.6 348.9 183.8 352 192 352s16.38-3.125 22.62-9.375L416 141.3l41.38 41.38c9.156 9.141 22.88 11.84 34.88 6.938C504.2 184.6 512 172.9 512 160V24C512 10.74 501.3 0 488 0z"></path></svg><p class="uagb-marketing-btn__prefix">Enjoy Maintenance-Free Protection for 2 Years</p></a></div>
</div>
</div></div>
...
<div class="uagb-ifb-title-wrap"><h2 class="uagb-ifb-title">Pure Water. Zero Hassle. Total Peace of Mind.</h2></div>
<p class="uagb-ifb-desc">From installation to ongoing support, we provide a complete RO water purification solution designed for convenience, reliability, and long-term performance.</p>
</div></div>



<div class="ro-advanced-grid ro-features-grid">
<div class="ro-advanced-card image-card">
<div data-aos="fade-up" data-aos-duration="400" data-aos-delay="0" data-aos-easing="ease" data-aos-once="true" class="wp-block-uagb-image alignleft uagb-block-f5f5e3e7 wp-block-uagb-image--layout-default wp-block-uagb-image--effect-static wp-block-uagb-image--align-left"><figure class="wp-block-uagb-image__figure"><img decoding="async" src="ro-water-purifier/image/support.jpg" alt="" class="uag-image-802" title="support" loading="lazy"></figure></div>
...
<div class="uagb-ifb-title-wrap"><h3 class="uagb-ifb-title"><strong><mark style="background-color:rgba(0, 0, 0, 0)" class="has-inline-color has-accent-3-color">Complete</mark> Service Support</strong></h3></div>
<p class="uagb-ifb-desc">We don’t just sell a water purifier — we provide complete support. From professional installation to scheduled maintenance guidance, our team ensures your purifier runs efficiently without stress or confusion.</p>
</div></div>
</div>

<div class="ro-advanced-card image-card">
<div data-aos="fade-up" data-aos-duration="400" data-aos-delay="0" data-aos-easing="ease" data-aos-once="true" class="wp-block-uagb-image alignleft uagb-block-4af1339e wp-block-uagb-image--layout-default wp-block-uagb-image--effect-static wp-block-uagb-image--align-left"><figure class="wp-block-uagb-image__figure"><img decoding="async" src="ro-water-purifier/image/control.jpg" alt="" class="uag-image-806" title="control" loading="lazy"></figure></div>
...
<div class="uagb-ifb-title-wrap"><h3 class="uagb-ifb-title"><strong>Intelligent <mark style="background-color:rgba(0, 0, 0, 0)" class="has-inline-color has-accent-3-color">Water Control</mark></strong></h3></div>
<p class="uagb-ifb-desc">With built-in TDS adjustment and multi-stage purification, you stay in control of your drinking water quality. Whether your source is borewell, tanker, or municipal supply, the system adapts for consistent performance.</p>
</div></div>
</div>

<div class="ro-advanced-card image-card">
<div data-aos="fade-up" data-aos-duration="400" data-aos-delay="0" data-aos-easing="ease" data-aos-once="true" class="wp-block-uagb-image alignleft uagb-block-da6fe1fb wp-block-uagb-image--layout-default wp-block-uagb-image--effect-static wp-block-uagb-image--align-left"><figure class="wp-block-uagb-image__figure"><img decoding="async" src="ro-water-purifier/image/everyday.jpg" alt="" class="uag-image-805" title="everyday" loading="lazy"></figure></div>
...
<div class="uagb-ifb-title-wrap"><h3 class="uagb-ifb-title"><strong>Reliable <mark style="background-color:rgba(0, 0, 0, 0)" class="has-inline-color has-accent-3-color">Everyday Performance</mark></strong></h3></div>
<p class="uagb-ifb-desc">Designed for continuous daily use, the 15 L/hr purification speed and 8-litre storage tank ensure your family always has safe drinking water ready — morning to night.</p>
</div></div>
</div>
</div>
</div></div>
...
<p>Getting safe drinking water at home has never been easier. From understanding your water source to professional installation and setup, our streamlined process ensures your RO purifier is ready to use quickly and correctly. Our trained technicians handle everything — so you enjoy pure water without stress.</p>
...
<span class="uagb-icon-list__source-wrap"><svg xmlns="https://www.w3.org/2000/svg" viewbox="0 0 256 512"><path d="M256 448c0 17.67-14.33 32-32 32H32c-17.67 0-32-14.33-32-32s14.33-32 32-32h64V123.8L49.75 154.6C35.02 164.5 15.19 160.4 5.375 145.8C-4.422 131.1-.4531 111.2 14.25 101.4l96-64c9.828-6.547 22.45-7.187 32.84-1.594C153.5 41.37 160 52.22 160 64.01v352h64C241.7 416 256 430.3 256 448z"></path></svg></span><span class="uagb-icon-list__label">1. Free Consultation<br><small>We understand your water source (borewell, tanker, or municipal) and recommend the right setup.</small></span>
</div>
...
<span class="uagb-icon-list__source-wrap"><svg xmlns="https://www.w3.org/2000/svg" viewbox="0 0 320 512"><path d="M320 448c0 17.67-14.33 32-32 32H32c-13.08 0-24.83-7.953-29.7-20.09c-4.859-12.12-1.859-26 7.594-35.03l193.6-185.1c31.36-30.17 33.95-80 5.812-113.4c-14.91-17.69-35.86-28.12-58.97-29.38C127.4 95.83 105.3 103.9 88.53 119.9L53.52 151.7c-13.08 11.91-33.33 10.89-45.2-2.172C-3.563 136.5-2.594 116.2 10.48 104.3l34.45-31.3c28.67-27.34 68.39-42.11 108.9-39.88c40.33 2.188 78.39 21.16 104.4 52.03c49.8 59.05 45.2 147.3-10.45 200.8l-136 130H288C305.7 416 320 430.3 320 448z"></path></svg></span><span class="uagb-icon-list__label">2. Custom Quotation<br><small>Transparent pricing with no hidden charges — including your 2-year complete maintenance coverage.</small></span>
</div>
...
<span class="uagb-icon-list__source-wrap"><svg xmlns="https://www.w3.org/2000/svg" viewbox="0 0 320 512"><path d="M320 344c0 74.98-61.02 136-136 136H103.6c-46.34 0-87.31-29.53-101.1-73.48c-5.594-16.77 3.484-34.88 20.25-40.47c16.75-5.609 34.89 3.484 40.47 20.25c5.922 17.77 22.48 29.7 41.23 29.7H184c39.7 0 72-32.3 72-72s-32.3-72-72-72H80c-13.2 0-25.05-8.094-29.83-20.41C45.39 239.3 48.66 225.3 58.38 216.4l131.4-120.4H32c-17.67 0-32-14.33-32-32s14.33-32 32-32h240c13.2 0 25.05 8.094 29.83 20.41c4.781 12.3 1.516 26.27-8.203 35.19l-131.4 120.4H184C258.1 208 320 269 320 344z"></path></svg></span><span class="uagb-icon-list__label">3. Schedule Installation<br><small>Choose a convenient time for installation at your home or office.</small></span>
</div>
...
<span class="uagb-icon-list__source-wrap"><svg xmlns="https://www.w3.org/2000/svg" viewbox="0 0 384 512"><path d="M384 334.2c0 17.67-14.33 32-32 32h-32v81.78c0 17.67-14.33 32-32 32s-32-14.33-32-32v-81.78H32c-10.97 0-21.17-5.625-27.05-14.89c-5.859-9.266-6.562-20.89-1.875-30.81l128-270.2C138.6 34.33 157.8 27.56 173.7 35.09c15.97 7.562 22.78 26.66 15.22 42.63L82.56 302.2H256V160c0-17.67 14.33-32 32-32s32 14.33 32 32v142.2h32C369.7 302.2 384 316.6 384 334.2z"></path></svg></span><span class="uagb-icon-list__label">4. Professional Setup<br><small>Our technician installs the purifier, checks water quality, adjusts TDS levels, and ensures everything works perfectly.</small></span>
</div>
...
<span class="uagb-icon-list__source-wrap"><svg xmlns="https://www.w3.org/2000/svg" viewbox="0 0 320 512"><path d="M320 344.6c0 74.66-60.73 135.4-135.4 135.4H104.7c-46.81 0-88.22-29.83-103-74.23c-5.594-16.77 3.469-34.89 20.23-40.48c16.83-5.625 34.91 3.469 40.48 20.23c6.078 18.23 23.08 30.48 42.3 30.48h79.95c39.36 0 71.39-32.03 71.39-71.39s-32.03-71.38-71.39-71.38H32c-9.484 0-18.47-4.203-24.56-11.48C1.359 254.5-1.172 244.9 .5156 235.6l32-177.2C35.27 43.09 48.52 32.01 64 32.01l192 .0049c17.67 0 32 14.33 32 32s-14.33 32-32 32H90.73L70.3 209.2h114.3C259.3 209.2 320 269.1 320 344.6z"></path></svg></span><span class="uagb-icon-list__label">5. 2-Year Maintenance Support<br><small>Enjoy complete peace of mind with filter replacement and essential maintenance covered for two full years.</small></span>
</div>
</div></div>



<div data-aos="fade" data-aos-duration="400" data-aos-delay="0" data-aos-easing="ease" data-aos-once="true" class="wp-block-uagb-marketing-button uagb-marketing-btn__align-left uagb-marketing-btn__align-text-right uagb-marketing-btn__icon-after uagb-block-78e25b5d wp-block-button hero-marketing-btn"><a href="#quotation" class="uagb-marketing-btn__link wp-block-button__link" target="" rel="noopener noreferrer"><span class="uagb-marketing-btn__title">GET FREE INSTALLATION &amp; 2-YEAR WARRANTY</span><svg xmlns="https://www.w3.org/2000/svg" viewbox="0 0 512 512"><path d="M384 320c-17.67 0-32 14.33-32 32v96H64V160h96c17.67 0 32-14.32 32-32s-14.33-32-32-32L64 96c-35.35 0-64 28.65-64 64V448c0 35.34 28.65 64 64 64h288c35.35 0 64-28.66 64-64v-96C416 334.3 401.7 320 384 320zM488 0H352c-12.94 0-24.62 7.797-29.56 19.75c-4.969 11.97-2.219 25.72 6.938 34.88L370.8 96L169.4 297.4c-12.5 12.5-12.5 32.75 0 45.25C175.6 348.9 183.8 352 192 352s16.38-3.125 22.62-9.375L416 141.3l41.38 41.38c9.156 9.141 22.88 11.84 34.88 6.938C504.2 184.6 512 172.9 512 160V24C512 10.74 501.3 0 488 0z"></path></svg><p class="uagb-marketing-btn__prefix">Enjoy Maintenance-Free Pure Water</p></a></div>
</div>
...
<div class="wp-block-column is-vertically-aligned-center is-layout-flow wp-block-column-is-layout-flow" style="flex-basis:50%">
<figure class="wp-block-image size-full has-custom-border is-style-rounded wp-duotone-unset-3 is-style-rounded--2"><img fetchpriority="high" decoding="async" width="1280" height="1280" src="ro-water-purifier/image/5easy.jpg" alt="" class="wp-image-973" style="border-radius:10px" srcset="ro-water-purifier/image/5easy.jpg 1280w, ro-water-purifier/image/5easy.jpg 300w, ro-water-purifier/image/5easy.jpg 1024w, ro-water-purifier/image/5easy.jpg 150w, ro-water-purifier/image/5easy.jpg 768w" sizes="(max-width: 1280px) 100vw, 1280px"></figure>
</div>
</div>
</div></div>
...
<p class="uagb-desc-text">Find answers to common questions about our RO Water Purifier and 2-Year Maintenance Plan.</p>
</div>
...
<div class="uagb-faq-questions-button uagb-faq-questions">			<span class="uagb-icon uagb-faq-icon-wrap">
			...
			<p class="uagb-question">Do you offer FREE installation services?</p>
</div>
<div class="uagb-faq-content"><p>Yes. We provide professional installation along with a complete installation kit worth ₹1500. Our technician installs the purifier, checks the water quality, and adjusts the TDS level for optimal performance.</p></div>
</div>
...
<div class="uagb-faq-questions-button uagb-faq-questions">			<span class="uagb-icon uagb-faq-icon-wrap">
			...
			<p class="uagb-question">Is there a warranty on the RO water purifier?</p>
</div>
<div class="uagb-faq-content"><p>Yes. We offer a 2-year complete warranty including filter replacement and essential maintenance support. Electrical components such as the booster pump and SMPS are covered as per warranty terms.</p></div>
</div>
...
<div class="uagb-faq-questions-button uagb-faq-questions">			<span class="uagb-icon uagb-faq-icon-wrap">
			...
			<p class="uagb-question">Are filter changes included for 2 years?</p>
</div>
<div class="uagb-faq-content"><p>Yes. Filter replacement is included during the 2-year maintenance period, ensuring you do not incur unexpected expenses during this time.</p></div>
</div>
...
<div class="uagb-faq-questions-button uagb-faq-questions">			<span class="uagb-icon uagb-faq-icon-wrap">
			...
			<p class="uagb-question">What types of water sources is this purifier suitable for?</p>
</div>
<div class="uagb-faq-content"><p>This purifier is designed for borewell water, tanker supply, tap water, and municipal water. The 7-stage RO + UV + UF system adapts to varying water conditions.</p></div>
</div>
...
<div class="uagb-faq-questions-button uagb-faq-questions">			<span class="uagb-icon uagb-faq-icon-wrap">
			...
			<p class="uagb-question">What is the storage capacity and purification speed?</p>
</div>
<div class="uagb-faq-content"><p>The purifier offers 8 litres of storage capacity and a purification rate of up to 15 litres per hour, making it ideal for daily family use.</p></div>
</div>
</div>
...
<div class="uagb-faq-questions-button uagb-faq-questions">			<span class="uagb-icon uagb-faq-icon-wrap">
			...
			<p class="uagb-question">Is the water safe from bacteria and viruses?</p>
</div>
<div class="uagb-faq-content"><p>Yes. The dual UV and UF protection system ensures microbiologically safe drinking water by eliminating harmful bacteria and pathogens.</p></div>
</div>
...
<div class="uagb-faq-questions-button uagb-faq-questions">			<span class="uagb-icon uagb-faq-icon-wrap">
			...
			<p class="uagb-question">What is TDS control and why is it important?</p>
</div>
<div class="uagb-faq-content"><p>The built-in TDS controller allows adjustment of the mineral content in water. It helps maintain balanced taste while reducing excess dissolved salts.</p></div>
</div>
...
<div class="uagb-faq-questions-button uagb-faq-questions">			<span class="uagb-icon uagb-faq-icon-wrap">
			...
			<p class="uagb-question">How hygienic is the storage tank?</p>
</div>
<div class="uagb-faq-content"><p>The purifier features a silicone O-ring sealed tank that prevents cockroaches and ants from entering, ensuring hygienic water storage.</p></div>
</div>
...
<div class="uagb-faq-questions-button uagb-faq-questions">			<span class="uagb-icon uagb-faq-icon-wrap">
			...
			<p class="uagb-question">What happens after the 2-year maintenance period?</p>
</div>
<div class="uagb-faq-content"><p>After the 2-year period, you may choose to continue with a paid service plan or schedule maintenance visits as needed.</p></div>
</div>
...
<div class="uagb-faq-questions-button uagb-faq-questions">			<span class="uagb-icon uagb-faq-icon-wrap">
			...
			<p class="uagb-question">How do I get started?</p>
</div>
<div class="uagb-faq-content"><p>Simply <a href="#quotation">contact us</a> for a free consultation. We will understand your water source, provide a transparent quotation, and schedule installation at your convenience.</p></div>
</div>
</div>
</div>
</div></div>
...
<script src="/ro-water-purifier/js/ro-water-purifier.js"></script>
    <script src="/ro-water-purifier/js/comparison-animations.js"></script>
<!-- Care Zero Modal -->
<div id="careZeroModal" class="modal">
  <div class="modal-content">
    <div class="modal-header">
      <span class="close-button">&times;</span>
      <h2>Get Care Zero Now</h2>
    </div>
    <div class="modal-body">
        <form id="cctv-requirement-form" class="crf-form">
            <div class="ro-plan-picker" data-plan-picker>
                <div class="ro-plan-options" role="radiogroup" aria-label="Plan duration">
                    <div class="ro-plan-item">
                        <input type="radio" id="ro-plan-2y" name="ro_plan_term" value="2" data-term-label="2 Years" data-monthly="189.00" data-total="7990.00" checked>
                        <label class="ro-plan-option" for="ro-plan-2y">
                            <div class="ro-plan-caption">2 Years<br><span class="ro-plan-monthly">₹ 189.00/mo</span></div>
                        </label>
                    </div>
                    <div class="ro-plan-item">
                        <input type="radio" id="ro-plan-3y" name="ro_plan_term" value="3" data-term-label="3 Years" data-monthly="169.00" data-total="9990.00" checked="checked">
                        <label class="ro-plan-option" for="ro-plan-3y" data-badge="Popular">
                            <div class="ro-plan-caption">3 Years<br><span class="ro-plan-monthly">₹ 169.00/mo</span></div>
                        </label>
                    </div>

                    <div class="ro-plan-item">
                        <input type="radio" id="ro-plan-5y" name="ro_plan_term" value="5" data-term-label="5 Years" data-monthly="149.00" data-total="13990.00">
                        <label class="ro-plan-option" for="ro-plan-5y">
                            <div class="ro-plan-caption">5 Years<br><span class="ro-plan-monthly">₹ 149.00/mo</span></div>
                        </label>
                    </div>
                </div>
                <div class="ro-plan-summary" data-plan-summary aria-live="polite">
                    <div class="ro-plan-summary-col-1">
                        <div class="ro-plan-summary-term">2 Years</div>
                        <div class="ro-plan-summary-price">₹ 7990.00</div>
                    </div>
                    <div class="ro-plan-summary-col-2">
                        <p><i class="fas fa-check-circle" style="color: #00c676; margin-right: 5px;"></i>ZERO FILTER COSTS</p>
                        <p><i class="fas fa-check-circle" style="color: #00c676; margin-right: 5px;"></i>ZERO SERVICE BILLS</p>
                        <p><i class="fas fa-check-circle" style="color: #00c676; margin-right: 5px;"></i>ZERO MAINTENANCE WORRIES</p>
                    </div>
                </div>
                <input type="hidden" name="ro_plan_total" value="7990.00" data-plan-total>
                <input type="hidden" name="ro_plan_monthly" value="189.00" data-plan-monthly>
            </div>
            <!-- Quotation Section -->
            <div class="crf-form-row" id="whatsapp-row" style="margin-top: 40px;">
                <div class="crf-form-col" style="display: flex; flex-direction: column; gap: 5px;">
                    ...
                    <div style="display: flex; align-items: center; gap: 10px;">
                        <div class="slider-input-wrapper input-with-icon">
                            ...
                            <input type="tel" id="whatsapp-number" name="whatsapp-number" class="input" placeholder="Enter your WhatsApp Number">
                        </div>
                        <button type="submit" id="next-button" class="input"><i class="fas fa-angle-double-right"></i></button>
                    </div>
                </div>
            </div>
