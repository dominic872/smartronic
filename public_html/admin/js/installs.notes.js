...
(function(){
    ...
    form.innerHTML = `
      ...
      <label class="np-field" style="display:grid;grid-template-columns:110px 1fr;align-items:center;gap:10px;margin:10px 0;">
        ...
        <div class="np-phone-wrap">
          <input type="text" id="notePhone" name="phone" placeholder="Enter phone or name (min 3 chars)" style="width:100%;padding:8px 10px;border:1px solid #ddd;border-radius:8px;font:inherit;outline:none;" />
  ...
  async function injectNotesForDate(dayEl, dateStr) {
    ...
    notes.forEach(note => {
      ...
      noteDiv.innerHTML = `
        <div class="note-header" style="color: ${typeColor}">
