...
<meta name="msapplication-TileImage" content="content/uploads/2025/01/cropped-Site-Icon-270x270.png">
    ...
    <style id="ads-landing-styles">
        .ads-cta-container { display: flex; gap: 15px; justify-content: center; margin: 20px 0; }
        .ads-cta-btn { border-radius: 8px; padding: 12px 25px; font-size: 16px; font-weight: 700; text-align: center; text-decoration: none; box-shadow: 0 4px 6px rgba(0,0,0,0.1); transition: all 0.3s ease; flex: 1; max-width: 250px; display: flex; align-items: center; justify-content: center; gap: 10px; border: none; cursor: pointer; font-family: inherit; }
        .ads-cta-whatsapp { background: #25D366; color: #fff !important; margin: 0; box-shadow: 0 4px 6px rgba(0,0,0,0.1); }
        .ads-cta-whatsapp > .fa-whatsapp:before {font-size: 30px;}
        .ads-cta-call > .fa-phone-alt:before {font-size: 22px;}
        .ads-cta-call { background: #FF0000; color: #fff !important; margin: 0; box-shadow: 0 4px 6px rgba(0,0,0,0.1); }
        .ads-cta-btn:hover { opacity: 0.9; color: #fff; text-decoration: none;}
        .ads-cta-form { display: flex; flex: 1 1 0; justify-content: center; margin: 0; max-width: 250px; }
        .ads-cta-form .ads-cta-btn { width: 100%; max-width: 100%; }
        .uagb-infobox__content-wrap {z-index: unset;}
        @media (max-width: 767px) {
            ...
            .ads-mobile-sticky .ads-cta-form {
                position: fixed;
                left: 15px;
                right: auto;
                bottom: 18px;
            ...
            .ads-mobile-sticky .ads-cta-whatsapp {
                position: static;
            }
            .ads-mobile-sticky .ads-cta-call {
                position: fixed;
                right: 15px;
                bottom: 18px;
                z-index: 9999;
        ...
        .ads-trust-signals { display: flex; align-items: center; justify-content: center; flex-wrap: wrap; gap: 15px; margin-top: 15px; font-size: 20px; font-weight: 500; color: #444; }
        .ads-trust-signals span { display: inline-flex; align-items: center; gap: 5px; }
        .ads-trust-signals i { color: #f39c12; }
        .ads-pricing-preview { background: #f8f9fc; border: 1px dashed #25D366; border-radius: 8px; padding: 15px; margin: 20px auto; max-width: 400px; text-align: center; }
        .ads-pricing-preview h4 { margin: 0 0 20px 0; font-size: 22px; color: #333; font-family: 'Raleway', sans-serif; font-weight: 900; }
        .ads-pricing-list { display: flex; flex-direction: column; gap: 8px; }
        .ads-pricing-item { display: flex; justify-content: space-between; font-weight: 600; font-size: 15px; border-bottom: 1px dashed #ccc; padding-bottom: 5px; }
        .ads-pricing-item:last-child { border-bottom: none; padding-bottom: 0; }
        .ads-modal-overlay { position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.6); z-index: 100000; display: none; align-items: center; justify-content: center; backdrop-filter: blur(3px); }
        .ads-modal-content { background: #fff; padding: 30px; border-radius: 12px; width: 90%; max-width: 400px; position: relative; text-align: center; }
        .ads-modal-close { position: absolute; top: 10px; right: 15px; font-size: 24px; cursor: pointer; color: #888; }
        .ads-modal-header { margin-bottom: 20px; }
        .ads-modal-header h3 { margin: 0 0 5px 0; font-size: 20px; font-family: 'Raleway', sans-serif; font-weight: 700; color: #111; }
        .form-hide-field { display: none !important; }
        .focus-form-header { text-align: center; font-size: 22px; font-weight: 700; margin-bottom: 15px; color: #111; font-family: 'Raleway', sans-serif; }
        .form-micro-copy { text-align: center; font-size: 16px; color: #666; margin-top: -10px; margin-bottom: 15px; }
        #cctv-requirement-form {border-radius: 8px; padding: 20px; background: #f8f9fc; max-width: 500px; margin: 0 auto;}
    </style>
</head>
...
<div id="quotation" class="wp-block-uagb-container crf-form-wrapper inpage-section uagb-block-c19de64c alignfull uagb-is-root-container">
  <div class="uagb-container-inner-blocks-wrap">
    ...
    <div class="wp-block-uagb-info-box uagb-block-298b74ff uagb-infobox__content-wrap uagb-infobox-icon-above-title uagb-infobox-image-valign-top" style="text-align: center;">
      <div class="uagb-ifb-content">
        <div class="uagb-ifb-title-wrap">
            <h1 class="uagb-ifb-title" style="font-size:clamp(28px, 5vw, 42px); font-weight: 800; line-height: 1.2; margin-bottom: 15px;">
              CCTV Installation in Bangalore <span class="hl">Starting ₹5,490</span>
            </h1>
        </div>

        <div class="uagb-ifb-desc gads-text" style="font-size: 18px; font-weight: 600;">
            <div class="shimmer-text" style="font-size: 20px; color: #000; ">

            <span>Free Installation </span> |
              <span>2 Years Service Warranty</span> |
          <span>Extendable up to 5 Years</span>
        ...
        <div class="ads-trust-signals">
            ...
            <span><i class="fas fa-shield-alt" style="color:#2ecc71;"></i> 2000+ Installations</span>
            <span><i class="fas fa-building" style="color:#3498db;"></i> Trusted by Homes & Offices</span>
        </div>

        <div class="ads-pricing-preview">
            <h4>Exclusive Package Prices</h4>
            <div class="ads-pricing-list">
                <div class="ads-pricing-item"><span>Wi-Fi Camera Full Setup</span> <span class="hl">₹5,490</span></div>
                <div class="ads-pricing-item"><span>4 CCTV Camera Free Installation</span> <span class="hl">₹16,990</span></div>
                <div class="ads-pricing-item"><span>8 CCTV With 2 Years Warranty</span> <span class="hl">₹24,990</span></div>
            </div>
        </div>
        
        <div class="ads-cta-container ads-mobile-sticky">
            <form 
            ...
            >
                ...
                <button type="submit" class="ads-cta-btn ads-cta-whatsapp">
                    <i class="fab fa-whatsapp"></i> Get Quote on <br />WhatsApp
                </button>
            </form>
            <a href="tel:8496080849" class="ads-cta-btn ads-cta-call">
...
<div class="wp-block-column form-holder is-layout-flow wp-block-column-is-layout-flow">    <div class="crf-container">
        <div class="focus-form-header">Get Free CCTV Quote in 30 Seconds</div>
        <div class="form-micro-copy">👉 Our expert will call you within 5 minutes</div>
        <form id="cctv-requirement-form" class="crf-form">
            <!-- No of Dome and Bullet Cameras -->
            <div class="crf-form-row bg-camera form-hide-field">
            ...
            <!-- Type of DVR needed -->
            <div class="crf-form-row form-hide-field">
                <div class="crf-form-col">
            ...
            <div class="crf-form-row">
                <div class="crf-form-col">
                    ...
                    <div class="slider-input-wrapper input-with-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="input-icon"><path d="M224 256c70.7 0 128-57.3 128-128S294.7 0 224 0 96 57.3 96 128s57.3 128 128 128zm89.6 32h-16.7c-22.2 10.2-46.9 16-72.9 16s-50.6-5.8-72.9-16h-16.7C60.2 288 0 348.2 0 422.4V464c0 26.5 21.5 48 48 48h352c26.5 0 48-21.5 48-48v-41.6c0-74.2-60.2-134.4-134.4-134.4z"/></svg>
                        <input type="text" id="customer-name" name="customer-name" class="input" placeholder="Your Full Name" required>
                    </div>
                </div>
            </div>
            ...
            <div class="crf-form-row">
                <div class="crf-form-col">
                    <label for="num-whatsapp">Mobile / WhatsApp Number</label>
                    <div class="slider-input-wrapper input-with-icon">
                    ...
                    <small>We will contact you via WhatsApp or Call</small>
                </div>
            ...
            <script>
                (function () {
                    ...
                    const syncSubmitState = () => {
                        const canSubmit = consent.checked && isValidWhatsapp();
                    ...
                    if (whatsappInput) {
                        whatsappInput.addEventListener('input', () => setTimeout(syncSubmitState, 0));
                    }

                    syncSubmitState();
                    window.addEventListener('load', () => setTimeout(syncSubmitState, 0));
                })();
            </script>
...
<div class="uagb-faq-content"><p>Simply <a href="#quotation" target="_blank">fill out the get quotation form</a> or <a href="tel:8496080849">call us</a> to schedule a free consultation. Our experts will assess your security needs and recommend the best solution for you.</p></div>
</div>
...
<p>Scan the QR code with your mobile <br>to call or click to call us at <br><a class="call-link" href="tel:8496080849">849 6080 849</a></p>
</div>
</div>
...
<div class="ads-modal-overlay" id="ads-modal">
    <div class="ads-modal-content">
        <div class="ads-modal-close" onclick="document.getElementById('ads-modal').style.display='none';">&times;</div>
        <div class="ads-modal-header">
            <h3>Wait! Get 10% Off Now</h3>
            <p style="font-size:14px; color:#555; margin:0;">Leave your details and our expert will call you with a special offer.</p>
        </div>
        <div style="text-align:left;">
            <div class="crf-form-col" style="margin-bottom:15px;">
                <label style="font-weight:bold; font-size:14px;">Your Name</label>
                <input type="text" id="modal-name" class="input" placeholder="Full Name" style="width:100%; padding:10px; border-radius:5px; border:1px solid #ccc;">
            </div>
            <div class="crf-form-col" style="margin-bottom:15px;">
                <label style="font-weight:bold; font-size:14px;">Mobile / WhatsApp</label>
                <input type="tel" id="modal-phone" class="input" placeholder="10-digit number" style="width:100%; padding:10px; border-radius:5px; border:1px solid #ccc;">
            </div>
            <button class="input ads-cta-whatsapp" id="modal-submit-btn" style="width:100%; border:none; padding:12px; font-weight:bold; cursor:pointer;" onclick="submitModal()">Get Free Quote</button>
        </div>
    </div>
</div>

<script>
    // 3 Second Delayed Modal
    setTimeout(function() {
    ...
    function submitModal() {
        ...
        if(phone.length >= 10) {
            document.getElementById('modal-submit-btn').innerText = 'Submitting...';
            // Pre-fill main form & submit
            document.getElementById('customer-name').value = name;
            document.getElementById('num-whatsapp').value = phone;
            document.getElementById('whatsapp-consent').checked = true;
            document.getElementById('next-button').disabled = false;
            
            // Hide modal and scroll to success message
            setTimeout(() => {
                document.getElementById('ads-modal').style.display = 'none';
                document.getElementById('cctv-requirement-form').dispatchEvent(new Event('submit'));
            }, 500);
        } else {
