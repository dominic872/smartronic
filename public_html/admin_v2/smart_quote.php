...
<head>
   ...
   <style>
    #breakdown h3,  #breakdown p {
        display:none;
    }

    #breakdown .from-cust,  #breakdown .from-cust + p, #breakdown .from-cust-disc {
            display: block;
        }

        .install-profit,
        .proffit-breakup, .smart {
