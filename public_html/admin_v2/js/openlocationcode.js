...
(function (root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    ...
    // Force global assignment even in CommonJS-like environments
    if (typeof window !== 'undefined') window.OpenLocationCode = module.exports;
  } else {
    // Browser globals
    root.OpenLocationCode = factory();
    if (typeof window !== 'undefined') window.OpenLocationCode = root.OpenLocationCode;
  }
}(this, function () {
