...
function updateDVRSelection() {
  ...
  if (cameraType === "5 mp" && manual === false) {
    ...
    dvrOptions += '<option value="1875">DVR 2 MP (4 CH) CP PLUS- ₹1875</option>';
    }
    if (numCameras > 4 && numCameras <= 8)
    ...
    if (numCameras > 16 && numCameras <= 32)
      ...
      dvrOptions += '<option value="1875">DVR 2 MP (8 CH) CP PLUS - ₹1875</option>';
  ...
  if (numCameras > 8) {
    smpsElement.value = "850";
  } else {
    smpsElement.value = "500";
  }
...
function calculateTotal() {
  ...
  console.log("cameraType:", cameraType);
  console.log("hardDisk:", hardDisk);
  console.log("camera:", camera);
  console.log("numCameras:", numCameras);
  console.log("dvr:", dvr);
  console.log("smps (before adjustment):", smps);
  console.log("poe (before adjustment):", poe);
  ...
  console.log("videoRecoder:", videoRecoder);
  console.log("smps (after adjustment):", smps);
  console.log("poe (after adjustment):", poe);
  ...
  console.log("bncBoxDC:", bncBoxDC);
  console.log("subtotal:", subtotal);
  console.log("gst:", gst);
  console.log("subtotalWithGST:", subtotalWithGST);
  console.log("totalWithInstallation:", totalWithInstallation);
  console.log("profit:", profit);
  console.log("totalBeforeDiscount:", totalBeforeDiscount);
  console.log("discount:", discount);
  console.log("finalTotal:", finalTotal);
  console.log("perCamValue:", perCamValue);
  console.log("profitValue:", profitValue);
  console.log("fixCamValue:", fixCamValue);
  console.log("finalLimitedProfit:", finalLimitedProfit);
  ...
  let message =
    ...
    `- Installation Services – Now Free!\n` +
